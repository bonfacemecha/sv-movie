...
import { Building2, Clapperboard, LogOut, LayoutDashboard } from 'lucide-vue-next';
                ...
                <ul class="space-y-2 mt-6 font-medium">
                    <li>
                        <RouterLink to="/"
                            ...
                            <LayoutDashboard class="text-gray-500 dark:text-gray-400 group-hover:text-gray-900" />
                    ...
                    <RouterLink
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                        to="/movies">
                        <Clapperboard class="text-gray-500 dark:text-gray-400 group-hover:text-gray-900" />
                    ...
                    <RouterLink
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                        to="/about">
                        <Building2 class="text-gray-500 dark:text-gray-400 group-hover:text-gray-900" />
                    ...
                    <li>
                        <a href="#" @click="handleSignOut"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <LogOut class="text-gray-500 dark:text-gray-400 group-hover:text-gray-900" />
