  ...
  <div>
    ...
    <div v-else class="pb-6">
      ...
      <div class="">
        ...
        <div
          class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-full bg-gray-50 py-8 px-3 rounded-sm">
          <!-- Movies Card -->
          <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow flex flex-col items-center">
            ...
            <router-link to="/movies">
              <button class="cursor-pointer bg-blue-600 text-white px-6 py-2 rounded-full text-lg hover:bg-blue-700 transition-all">
                Go to Movies
              </button>
            </router-link>
          </div>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow flex flex-col items-center">
            ...
            <router-link to="#">
              <button
                class="cursor-pointer bg-yellow-500 text-white px-6 py-2 rounded-full text-lg hover:bg-yellow-600 transition-all">
                View Favorites
              </button>
            </router-link>
          </div>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow flex flex-col items-center">
            ...
            <router-link to="/movies">
              <button class="cursor-pointer bg-green-500 text-white px-6 py-2 rounded-full text-lg hover:bg-green-600 transition-all">
                Search Movies
              </button>
            </router-link>
          </div>
      ...
      <div class="mt-8 text-center">
        <router-link to="/movies">
          <button class="cursor-pointer bg-blue-600 text-white px-8 py-3 rounded-full text-lg hover:bg-blue-700 transition-all">
