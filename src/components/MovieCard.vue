<template>
  <router-link :to="`/movie/${movie.id}`" class="block">
    <div
      ...
      <img :src="getPosterUrl(movie.poster_path)" :alt="movie.title" class="w-full h-64 object-cover" />
      <div class="p-4">
        ...
        <div class="flex justify-between items-center mt-4">
          <span v-if="movie.vote_average != null" class="text-yellow-600 font-bold">
            ⭐ {{ movie.vote_average.toFixed(1) }}
          </span>
          <span v-else class="text-gray-500">No rating</span>
